...
class DeviceRepositoryTest {
        ...
        void findByRoom_RoomId_ReturnsDevicesInRoom() {
                ...
                assertTrue(
                                livingRoomDevices.stream()
                                                .anyMatch(d -> d.getDeviceName().equals("Living Room Light")));
                assertTrue(
                                livingRoomDevices.stream()
                                                .anyMatch(d -> d.getDeviceName().equals("Living Room Camera")));
        }
        ...
        void findByHomeId_ValidHomeId_ReturnsAllDevicesInHome() {
                ...
                assertTrue(
                                homeDevices.stream().anyMatch(d -> d.getDeviceName().equals("Living Room Light")));
                assertTrue(
                                homeDevices.stream().anyMatch(d -> d.getDeviceName().equals("Kitchen Thermostat")));
                assertTrue(
                                homeDevices.stream().anyMatch(d -> d.getDeviceName().equals("Living Room Camera")));
        }
        ...
        void existsByDeviceNameAndRoom_RoomId_ExistingDevice_ReturnsTrue() {
                boolean exists =
                                deviceRepository.existsByDeviceNameAndRoom_RoomId(

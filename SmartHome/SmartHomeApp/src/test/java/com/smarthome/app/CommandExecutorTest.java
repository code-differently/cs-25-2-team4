...
public class CommandExecutorTest {
  ...
  class LightCommandExecution {
          ...
          assertThrows(
              ...
              () ->
                  commandExecutor.execute(
                      light, "setBrightness", 75.5) // Double instead of Integer/String
              );
    ...
    void testSetBrightnessWithoutArguments() {
      InvalidCommandException exception =
          assertThrows(
              InvalidCommandException.class, () -> commandExecutor.execute(light, "setBrightness"));
  ...
  class ThermostatCommandExecution {
    ...
    void testSetTempWithoutArguments() {
      InvalidCommandException exception =
          assertThrows(
              InvalidCommandException.class, () -> commandExecutor.execute(thermostat, "setTemp"));
    ...
    void testSetTempOnNonThermostat() {
      ...
      InvalidCommandException exception =
          assertThrows(
              InvalidCommandException.class, () -> commandExecutor.execute(light, "setTemp", 22.0));
    ...
    void testGetTempOnNonThermostat() {
      ...
      InvalidCommandException exception =
          assertThrows(
              InvalidCommandException.class, () -> commandExecutor.execute(light, "getTemp"));
  ...
  class SecurityCameraCommandExecution {
    ...
    void testCameraCommandsOnNonCamera() {
      ...
      InvalidCommandException startException =
          assertThrows(
              InvalidCommandException.class,
              () -> commandExecutor.execute(light, "startRecording"));
      assertTrue(startException.getCause().getMessage().contains("not a SecurityCamera"));

      InvalidCommandException stopException =
          assertThrows(
              InvalidCommandException.class, () -> commandExecutor.execute(light, "stopRecording"));
      assertTrue(stopException.getCause().getMessage().contains("not a SecurityCamera"));

      InvalidCommandException isRecordingException =
          assertThrows(
              InvalidCommandException.class, () -> commandExecutor.execute(light, "isRecording"));
  ...
  class SwitchableDeviceCommandExecution {
    ...
    void testSwitchableCommandsOnNonSwitchableDevice() {
      ...
      Device nonSwitchableDevice =
          new Device("D001", "Non-Switchable Device") {
            @Override
      ...
      InvalidCommandException turnOnException =
          assertThrows(
              InvalidCommandException.class,
      ...
      InvalidCommandException turnOffException =
          assertThrows(
              InvalidCommandException.class,
  ...
  class ErrorHandling {
    ...
    void testNullDevice() {
      InvalidCommandException exception =
          assertThrows(
              InvalidCommandException.class, () -> commandExecutor.execute(null, "turnOn"));
  ...
  class ExceptionConstructorTests {
    ...
    void testInvalidCommandExceptionConstructors() {
      ...
      InvalidCommandException messageCauseException =
          new InvalidCommandException("Test with cause", cause);

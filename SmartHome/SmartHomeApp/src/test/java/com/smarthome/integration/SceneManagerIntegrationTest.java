...
/**
 * Integration tests for SceneManager that address User Story 2: "As a homeowner I want to create a
 * Scene that runs multiple device actions (e.g., dim lights, set thermostat) so that I can change
 * my home's mood with one command."
 */

...
public class HomePrompter {
    ...
    public HomePrompter(Scanner scanner, HomeManager homeManager, SceneManager sceneManager, RuleEngine ruleEngine) {
    ...
    public void startMenuLoop() {
        ...
        while (running) {
            ...
            switch (choice) {
                ...
                case "4": listDevicesInRoom(); break;
                case "5": toggleDevice(); break;
                case "6": createScene(); break;
                case "7": listScenes(); break;
                case "8": runScene(); break;
                case "9": addRule(); break;
                case "10": running = false; break;
                case "11": simulateEvent(); break;
    ...
    private void addDevice() {
        ...
        Device device;
        switch (type) {
            case "light": device = new Light(id, name); break;
            case "thermostat": device = new Thermostat(id, name); break;
            case "securitycamera": device = new SecurityCamera(id, name); break;
            default: System.out.println("Unknown device type."); return;
        }
    ...
    private void listDevicesInRoom() {
        ...
        room.getDevices().forEach(d -> System.out.println(" - " + d.getDeviceName() + " [" + d.getDeviceId() + "] Status: " + d.getStatus()));
    }
    ...
    private void toggleDevice() {
        ...
        if (cmd.equals("on")) s.turnOn(); else if (cmd.equals("off")) s.turnOff();
